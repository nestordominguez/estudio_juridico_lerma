...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { comentarios: @contacto.comentarios, email: @contacto.email, name: @contacto.name, phone: @contacto.phone }
    end
  ...
  test "should update contacto" do
    patch :update, id: @contacto, contacto: { comentarios: @contacto.comentarios, email: @contacto.email, name: @contacto.name, phone: @contacto.phone }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
